...
<head>
  ...
  <link rel="shortcut icon" sizes="32x32" href="{{ asset('public/assets/media/favicons/logo-jki.png') }}">
  ...
  <style>
    .adm-image {
      background-image: url("{{ asset('public/images/bg/bgbr.png') }}");
  ...
  <div class="login-box">
    ...
    <div class="login-box-body">
      <div class="login-logo">
        <img src="{{ asset('public/images/logo-jki.png') }}" width="200">
      </div>
